...
import com.sadoyin.memory3.utils.*
import java.io.ByteArrayOutputStream

class CreateActivity : AppCompatActivity() {

    companion object{
        private const val PICK_PHOTO_CODE = 13
        private const val READ_EXTERNAL_PHOTOS_CODE = 243
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode== READ_EXTERNAL_PHOTOS_CODE){
            if (grantResults.isNotEmpty() && grantResults[0] ==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this,"In order to create a game, you need to provide access to your photos", Toast.LENGTH_LONG).show()
    ...
    private fun saveDataToFirebase() {
        ...
        db.collection("gsmes").document(customGameName).get().addOnSuccessListener {document->
    ...
    private fun handleImageUploading(gameName: String) {
        ...
        for ((index,photoUri:Uri) in chosenImageUris.withIndex()){
            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask{photoUpLoadTask ->
                    ...
                    if (!downloadUrlTask.isSuccessful){
                        Toast.makeText(this,"Fialed to Upload image",Toast.LENGTH_SHORT).show()
